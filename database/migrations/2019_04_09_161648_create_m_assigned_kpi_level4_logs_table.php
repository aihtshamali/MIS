...
class CreateMAssignedKpiLevel4LogsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('m_assigned_kpi_level4_logs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('m_assigned_kpi_level4_logs');
    }
}
