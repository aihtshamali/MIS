...
$('#example4').DataTable()
    ...
    "dataProvider": [ {
      ...
      "Number of Projects": (total_assigned_projects/total_projects*100).toFixed(2) < 1 ? 1 : (total_assigned_projects/total_projects*100).toFixed(2),
      "color": "#333"
    }, {
      "Type": "Inprogress\nProjects\n({{$inprogress_projects}})",
      "Number of Projects": (inprogress_projects/total_projects*100).toFixed(2) < 1 ? 1 : (inprogress_projects/total_projects*100).toFixed(2),
      "color": "#2A0CD0"
    }, {
      "Type": "Completed\nProjects\n({{$completed_projects}})",
      "Number of Projects": (completed_projects/total_projects*100).toFixed(2) < 1 ? 1 : (completed_projects/total_projects*100).toFixed(2),
      "color": "#8A0CCF"
    } ],
    "valueAxes": [ {
      "title" : "Percentage",
