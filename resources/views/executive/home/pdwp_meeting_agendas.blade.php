                        ...
                        <div class="form-group row">
                            <div class="form-group row" style="display:flex;justify-content:center;">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea disabled class="form-control autoExpand" id="name_of_scheme" name="name_of_scheme[]" type="text" style="text-align:center;">
                                    {{$agenda->scheme_name}}
                                    </textarea>
                                </div>
                            </div>
    ...
    <div class="col-md-12" id="adpdiv" style="padding:0 !important">
        ...
        <div class="form-group" id="datepick" style="margin-top:10px">
            ...
            <select name="my_time[]" class="form-control select2" style="text-align: center !important" id="">
                ...
                @for ($i = 9; $i < 12; $i++) @for($j=0; $j <=45; $j+=15) @if($j==0) <option value="{{$i . ' : ' . $j.'0' .' AM'}}"> {{$i . " : " . $j .'0'}} AM</option>
                    @else
                    ...
                    @for ($i = 1; $i <= 5; $i++) @for($j=0; $j <=45; $j+=15) @if($j==0) <option value="{{$i . ' : ' . $j.'0' . ' PM' }}"> {{$i . " : " . $j .'0'}} PM</option>
                        @else
                        ...
                        <li class="list-group-item " id="field">
                            <div class="form-group row" style="margin-left:20px;margin-right:20px" id="main">
                                ...
                                <div id="<?php echo $var ?>" style="margin-top:20px">
                                    ...
                                    @if($var <= $c) <button class="btn btn-success add-more pull-right" type="button">Next</button>
                                        @endif
                                        @if($var > $c)
                                        ...
                                        @endif
                                        @if($var <= 2) <button class="btn btn-info pull-left back-more" type="button">Back to Summary</button>
                                            @endif
                                </div>
                            </div>
                        </li>
