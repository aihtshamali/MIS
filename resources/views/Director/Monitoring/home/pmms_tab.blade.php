      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">Avearge Time for Activities</h3>
            ...
            <div class="box-body">
              <div class="chart">
                <canvas class="barChart" id="averagetimeforactivities" style="height:250px"></canvas>
              </div>
            </div>
            <!-- /.box-body -->
          </div>
          ...
          <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">Yearly Projects Progress</h3>
          ...
          <div class="box box-warning">
                ...
                <div class="box-body">
                  <canvas class="barChart" style="height:250px"></canvas>
                </div>
                <!-- /.box-body -->
              </div>
        ...
        <div class="col-md-6">
         {{--  Chart 4 --}}
          <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">Number of Reports</h3>
    ...
    var bChartData = {
      ...
      datasets: [
        ...
        },
        {
          ...
          data                : [28, 48, 40, 19, 86, 27,60, 90]
        }
      ]
    }
    var barChartData                     = bChartData
