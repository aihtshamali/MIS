        ...
        <div class="col-md-6">
                ...
                <div class="box box-info">
                  <div class="box-header with-border">
                    <h3 class="box-title">New Project Types</h3>
                  </div>
                  <!-- /.box-header -->
                  <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{route('project_type.store')}}" >
                    {{csrf_field()}}
                    <div class="box-body">
                        <div class="form-group col-md-12" id="field">
                            <span class="firstspan">
                                <label for="" >ProjectType </label>
                                <input autocomplete="off" name="project_types[]" id="field1" type="text" class="form-control input"value="" data-items="8">
        ...
        $(document).ready(function(){
          ...
          $(".add-more").click(function(e){
            //   console.log('adsf');
              ...
              next = next + 1;
              var newIn = '<div class="added'+(next-1)+'" > <label for="">ProjectType </label><input name="project_types[]" autocomplete="off" class="input form-control" id="field'+ next +'" value="'+$('input#field1').val()+'" type="text"> ';
            //   var newInput = $(newIn);
