...
<div class="row">
    ...
    <div class="card z-depth-5">
        <div class="card-header"> <h4><b>Completed Monitoring Projects</b></h4></div>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><div class="progress">
                                            <div class="progress-bar progress-bar-striped progress-bar-success" role="progressbar" style="width: 100%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"> 100%</div>
                                        </div></td>
                                </tr>
