...
<div class="row">
    <div class="col-md-12">
        <form id="assigntoConsultantForm"  action="{{route('assignproject.store')}}" method="POST">
          {{ csrf_field() }}
          <input type="hidden" name="project_id" value="{{$project_id}}">
          <input type="hidden" name="priority" value="{{$priority}}">
          <input type="hidden" name="gotoroute" value="monitoring_unassigned">
        ...
        <div class="card ">
            ...
            <div class="card-block">
                <div class="row">
                    ...
                    <div class="col-md-4 form-radio">
                        <div class="radio radiofill radio-primary radio-inline">
                            <label>
                                <input type="radio"  name="assign_to" value="manager" >
                ...
                <div class="row director">
                        <div class="col-md-6 form-group offset-md-3">
                            <select name="manager_id[]" class="js-example-basic-multiple js-placeholder-multiple col-sm-12 form-control" multiple="multiple" data-placeholder="Select..">
