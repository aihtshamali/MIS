...
<div class="card" id='exportContent'>
    ...
    <div class="mainpage col-md-12">
        ...
        <div class="col-md-12 row">
            ...
            <img src="http://172.16.10.14/storage/uploads/monitoring/'.$attachment->m_project_progress_id.'/'.$attachment->project_attachement}}" class="col-md-8 offset-md-2 pdtop1p" style="max-height:300px;" alt="">
            <div class="pdtop3p offset-md-2 col-md-8">
                <!-- <div class="row">
                    <div class="col-md-12">
