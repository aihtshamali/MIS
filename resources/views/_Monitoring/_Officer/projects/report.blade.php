...
<body>
    ...
    <div class="card" id='exportContent'>
        ...
        <div class="breakpage col-md-12 topic pdtop3p clearfix">
        ...
        <!-- myCode ends here -->
        {{-- Conduct Monitoring --}}
        <div class="cad-block pdtop3p">
            {{-- Quality Assesments --}}
            <div class="row pdtop3p" style="">
                <div class="col-md-12 text-center breakpage">
                ...
                <div class="col-md-12 pdtop2p breakpage">
