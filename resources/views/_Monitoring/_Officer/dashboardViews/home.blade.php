                ...
                <div class="card-block">
                    <div class="row m-b-25">
                        <div class="col-auto p-r-0">
                            <div class="u-img">
                                    <img src={{asset('_monitoring/css/images/breadcrumb-bg.jpg')}} alt="user image" class="img-radius cover-img">
                                    <img src={{asset('_monitoring/css/images/avatar-2.jpg')}} alt="user image" class="img-radius profile-img">
                            </div>
                        </div>
                        <div class="col">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="b-none">
                                                    ...
                                                    <img src={{asset('_monitoring/css/images/avatar-2.jpg')}} alt="user image" class="img-radius img-40 align-top m-r-15">
                ...
                <div class="row m-l-0 m-r-0">
                    <div class="col-sm-4 bg-c-lite-green user-profile">
                        <div class="card-block text-center text-white">
                            <div class="m-b-25">
                                    <img src={{asset('_monitoring/css/images/avatar-4.jpg')}} alt="user image" class="img-radius img-40 align-top m-r-15">
                                </div>
                        ...
                        <div class="card-block">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <h6 class="text-muted f-w-400"><a href="https://colorlib.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="563c33382f16313b373f3a7835393b">[email&#160;protected]</a></h6>
                                </div>
                                <div class="col-sm-6">
