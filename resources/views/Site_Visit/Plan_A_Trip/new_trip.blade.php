...
<link rel="stylesheet" href="{{ asset('_monitoring/css/multiselect/css/multi-select.css')}}" />
    ...
    .bg{background-color: #f6f7fb;padding: 1% 0.5%;border-radius:5px;}
    ...
    #brief, #briefround{width:81.5% !important;}
    ...
    .select2-container{pad: 1% !important;}
    .select2-container--default .select2-selection--multiple .select2-selection__rendered{padding: 1% !important;}
</style>
@endsection
@section('content')
    <form action="" class="offset-md-1 col-md-9 form-control form-control-default">
                    ...
                    <div id="clonethisproposal_1" class="w3-animate-top">
                        <div class="col-md-12 inlinebox">
                            ...
                            <div id='gsrow' class="col-md-10 row nodisplay w3-animate-left nopadlefright">
                                ...
                                <div class="col-md-7 nopadlefright">
                                    <select name="select" class="form-control form-control-default">
                        ...
                        <div class="col-md-12 inlinebox border">
                ...
                <div class="sinpuroundposeout">
                  ...
                  <div id="roundtripp_1">
                    <div class="col-md-12 inlinebox">
                      ...
                      <div id='gsrowround' class="nodisplay col-md-10 row w3-animate-left nopadlefright">
                          <div class="col-md-2 nopadlefright">
                              <select name="select" class="form-control form-control-default">
                                  <option value="opt1" selected>Year</option>
                              </select>
...
<script>
    ...
    <div id="roundtripp_1">
                    <div class="col-md-12 inlinebox">
                      ...
                      <div id='gsrowround' class="col-md-10 row nopadlefright">
                          <div class="col-md-2">
                              <select name="select" class="form-control form-control-default">
                                  <option value="opt1" selected>Year</option>
                              </select>
