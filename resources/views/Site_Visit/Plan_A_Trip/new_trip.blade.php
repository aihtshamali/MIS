    ...
    <form action="" class="offset-md-2 col-md-8 form-control form-control-default">
            ...
            <div class="outstation">
                ...
                <div class="sinpurposeout">
                  <div class="col-md-12">
                      <div class="form-radio">
                          <div class="radio radio-outline radio-inline">
                              <label>
                                  <input type="radio" class="sinpurroundcity" name="radiocityout" checked="checked">
                                  <i class="helper"></i>round trip
                              </label>
                          </div>
                          <div class="radio radio-outline radio-inline">
                              <label>
                                  <input type="radio" class="sinpurmulticity" name="radiocityout">
                ...
                <div class="form-group">
                  ...
                  <div class="addroundclonehere"></div>
                  <div class="form-group">
                      <div class="nodisplay addnewroundproposal btn btn-primary btn-outline-primary btn-block"><i class="icofont icofont-plus"></i>Add City</div>
                  </div>
                  <div class="form-group">
                      <button class="btn btn-primary btn-block"><i class="icofont icofont-user-alt-3"></i>Submit</button>
                  </div>
