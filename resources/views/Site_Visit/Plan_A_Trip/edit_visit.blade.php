...
@section('content')
@include('inc.msgs')
<form action="{{route('trip.update',$trip->id)}}" id= "tripform" method="POST"  class="col-md-12 form-control">
    {{ csrf_field() }}
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-8 offset-md-2">
                                ...
                                <select name="triptype_id" id="triptype_id" class="triptype_id form-control form-control-primary">
                                    ...
                                    <option value="{{$triptype->id}}" {{$triptype->id == $trip->plantrip_triptype_id ? 'selected' : ''}}>{{$triptype->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
