...
class OfficerController extends Controller
{
    ...
    public function saveDocAttachments(Request $request){
      ...
      // dd($level_1[0]->MAssignedKpiLevel2[1]->MAssignedKpiLevel3);
        ...
        compact('financial_progress','result_from_app','org_project','org_projectId','projectProgressId','mPlanKpiComponents','ComponentActivities','monitoringProjectId','Kpis','components','objectives','sectors','sub_sectors','project','costs','location','organization','dates','progresses','generalFeedback','issue_types','healthsafety'));
      }
